  ...
  return (
    <div className='box  has-text-grey'>
      ...
      <div className='columns'>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className={highlightClass}>
                  {lastPointed && security
                    ? formatIntl(lastPointed, security.currency)
                    : 'N/A'}
                </td>
              </tr>
              <tr style={{ backgroundColor: 'gainsboro' }}>
              ...
              <tr style={{ backgroundColor: 'gainsboro' }}>
                ...
                <td style={{ verticalAlign: 'middle' }}>
                  {security &&
                  security.liveData &&
                  security.liveData.previousOpen
              ...
              <tr>
                ...
                <td style={{ verticalAlign: 'middle' }}>
                  {security &&
                  security.liveData &&
                  security.liveData.previousClose
              ...
              <tr style={{ backgroundColor: 'gainsboro' }}>
                ...
                <td>
                  {security &&
                  security.liveData &&
                  security.liveData.cumulativeVolume
        ...
        >
          {security === undefined || security.historyPrice100 === undefined ? (
            <Loading style={{ height: 400 }} />
          ) : security === null ||
            security.historyPrice100 === null ||
            security.historyPrice100.length == 0 ? (
              <span>No Data</span>
            ) : (
              <AreaGraphContainer
