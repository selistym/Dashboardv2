        ...
        <g width={svgDimen.width} height={svgDimen.height} transform={`translate(${margins.left}, 0)`}>
          <g className="chartBase" transform={`translate(${svgDimen.width / 2} , 0)`}>
            ...
            >
              ...
              <g>
                <circle r="5" cx="35" cy={legend_label_height * 2} fill="#cc7332" />
                <text
                  x="45"
              ...
              <g>
                <circle r="5" cx="35" cy={legend_label_height * 3} fill="#ff8c00" />
                <text
                  x="45"
...
class Bar extends Component {
  ...
  drawBar() {
    ...
    let colors = ['#63ae2d', '#a6ae2d', '#cc7332', '#de0730', '#ff8c00'];
    ...
    for (let i = 0; i < data.length; i++) {
      barArea
        ...
        // })
        .style('fill', () => (identy == 'left' && i == 3 ? colors[4] : colors[i]));
      // .style('opacity', 0);
