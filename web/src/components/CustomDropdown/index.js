          ...
          <div style={{ display: 'flex', width: '100%' }}>
            ...
            <div style={{ textAlign: 'right', width: '100%' }}>
              <input
                className={
                  checked
                    ? 'is-checkradio is-rtl has-background-color is-danger'
                    : 'is-checkradio is-rtl has-background-color'
                }
              ...
              />
              <label
                htmlFor={'checkbox' + parent_index + index}
      ...
      >
        ...
        >
          <div className='dropdown-item' style={{ width: 250 }}>
            <button className='button is-small' onClick={() => onSelectAll()}>
              Select all
            </button>
            <button
          ...
          {items.map((item, i) => (
            <DropdownItem
              ...
              parent_index={index}
              index={i}
              checked={initial.indexOf(item.code) != -1}
