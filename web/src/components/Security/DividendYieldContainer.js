        ...
        <div className="box  has-text-grey">
            ...
            <div className="content">
                ...
                <div className="column is-one-two-mobile is-one-two-tablet has-text-centered">
                    ...
                    {security === undefined || security.factsetData === undefined || security.factsetData.Daily_DividendYieldDaily === undefined ? <Loading style={{height: 300}}/>
                        : security === null || security.factsetData === null || security.factsetData.Daily_DividendYieldDaily === null ? <span>No Data</span>
