...
const BarGroup = ({ data, bandwidth, xScale, step_data, identy, sector }) => {
  ...
  const drawBarGroup = () => {
    ...
    const color = d3
      .scaleOrdinal()
      .range(['#32CD32', '#006400', '#808080', '#000000'])
...
const NegativeGraph = ({ width, height, data, sector }) => {
  ...
  const getRange = data => {
    ...
    let max = d3.max(d3.values(arr)) * 1.2
  ...
  const barGroups = useMemo(
    () =>
      data.map((d, i) => (
        <g
          key={i}
          className={`bar-group${d.year}`}
          transform={`translate(0, ${y0Scale(d.year)})`}
        >
          <BarGroup
            key={i}
            identy={i}
      ...
      values: [
        {
          ...
          value: data.NetoperatingCashFlowLY ? data.NetoperatingCashFlowLY : 0
        },
        {
          label: 'NetInvestingCashFlowLY',
          value: data.NetInvestingCashFlowLY ? data.NetInvestingCashFlowLY : 0
        },
        {
          label: 'NetFinancingCashFlowLY',
          value: data.NetFinancingCashFlowLY ? data.NetFinancingCashFlowLY : 0
        },
        {
          label: 'NetchangeInCashLY',
          value: data.NetchangeInCashLY ? data.NetchangeInCashLY : 0
        },
      ...
      values: [
        {
          ...
          value: data.NetoperatingCashFlowLYMin1
            ? data.NetoperatingCashFlowLYMin1
            : 0
        },
        {
          label: 'NetInvestingCashFlowLYMin1',
          value: data.NetInvestingCashFlowLYMin1
            ? data.NetInvestingCashFlowLYMin1
            : 0
        },
        {
          label: 'NetFinancingCashFlowLYMin1',
          value: data.NetFinancingCashFlowLYMin1
            ? data.NetFinancingCashFlowLYMin1
            : 0
        },
        {
          label: 'NetchangeInCashLYMin1',
          value: data.NetchangeInCashLYMin1 ? data.NetchangeInCashLYMin1 : 0
        },
        {
          label: 'EbitdaLYMin1',
          value: data.EbitdaLYMin1 ? data.EbitdaLYMin1 : 0
        }
      ]
    },
    {
      ...
      values: [
        {
          ...
          value: data.NetoperatingCashFlowLYMin2
            ? data.NetoperatingCashFlowLYMin2
            : 0
        },
        {
          label: 'NetInvestingCashFlowLYMin2',
          value: data.NetInvestingCashFlowLYMin2
            ? data.NetInvestingCashFlowLYMin2
            : 0
        },
        {
          label: 'NetFinancingCashFlowLYMin2',
          value: data.NetFinancingCashFlowLYMin2
            ? data.NetFinancingCashFlowLYMin2
            : 0
        },
        {
          label: 'NetchangeInCashLYMin2',
          value: data.NetchangeInCashLYMin2 ? data.NetchangeInCashLYMin2 : 0
        },
        {
          label: 'EbitdaLYMin2',
          value: data.EbitdaLYMin2 ? data.EbitdaLYMin2 : 0
        }
      ]
    },
    {
      ...
      values: [
        {
          ...
          value: data.NetoperatingCashFlowLYMin3
            ? data.NetoperatingCashFlowLYMin3
            : 0
        },
        {
          label: 'NetInvestingCashFlowLYMin3',
          value: data.NetInvestingCashFlowLYMin3
            ? data.NetInvestingCashFlowLYMin3
            : 0
        },
        {
          label: 'NetFinancingCashFlowLYMin3',
          value: data.NetFinancingCashFlowLYMin3
            ? data.NetFinancingCashFlowLYMin3
            : 0
        },
        {
          label: 'NetchangeInCashLYMin3',
          value: data.NetchangeInCashLYMin3 ? data.NetchangeInCashLYMin3 : 0
        },
        {
          label: 'EbitdaLYMin3',
          value: data.EbitdaLYMin3 ? data.EbitdaLYMin3 : 0
        }
      ]
    },
    {
      ...
      values: [
        {
          ...
          value: data.NetoperatingCashFlowLYMin4
            ? data.NetoperatingCashFlowLYMin4
            : 0
        },
        {
          label: 'NetInvestingCashFlowLYMin4',
          value: data.NetInvestingCashFlowLYMin4
            ? data.NetInvestingCashFlowLYMin4
            : 0
        },
        {
          label: 'NetchangeInCashLYMin4',
          value: data.NetchangeInCashLYMin4 ? data.NetchangeInCashLYMin4 : 0
        },
        {
          label: 'NetFinancingCashFlowLYMin4',
          value: data.NetFinancingCashFlowLYMin4
            ? data.NetFinancingCashFlowLYMin4
            : 0
        },
        {
          label: 'EbitdaLYMin4',
          value: data.EbitdaLYMin4 ? data.EbitdaLYMin4 : 0
        }
      ]
    }
  ]
